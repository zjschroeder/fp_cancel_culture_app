...
# ahh this is fun (re:furr) - i'd heard of the package but wasn't aware of what the added value above purr was. i'll definitely be looking into using furr for some future projects
...
## it's amazing how brief this code is, i've never done a sentiment analysis but i assumed it would be much more involved. great work getting it pared down so much
